...
import pickle
app= Flask(__name__)
model = pickle.load(open('C:/Users/ashut/Downloads/Compressed/campus_recruitment_prediction/campus_recruitment_prediction/model.pkl', 'rb'))
scaler = pickle.load(open('C:/Users/ashut\Downloads/Compressed/campus_recruitment_prediction/campus_recruitment_prediction/scaler.pkl', 'rb'))
